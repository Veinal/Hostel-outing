...
export const BulkStudentImport = ({ onClose, onStudentsAdded }) => {
  ...
  const downloadTemplate = () => {
    const template = `email,fullName,phone,branch,year,block,room,photoUrl\nstudent1@example.com,John Doe,1234567890,Computer Science,2,A,101,https://example.com/photo1.jpg\nstudent2@example.com,Jane Smith,0987654321,Electrical Engineering,3,B,205,https://example.com/photo2.jpg`;
            ...
            <div className="space-y-6">
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                ...
                <ul className="text-blue-700 text-sm space-y-1">
                  ...
                  <li>• Required: email, fullName, phone, branch, year, block, room</li>
